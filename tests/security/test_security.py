...
class TestSecurity(unittest.TestCase):
    ...
    def test_security(self):
        ...
        self.assertEqual(headers.get('Content-Security-Policy'), "default-src 'self' matomo.fairdata.fi matomo.fd-test.csc.fi; img-src * data:")
        self.assertEqual(headers.get('X-Content-Security-Policy'), "default-src 'self' matomo.fairdata.fi matomo.fd-test.csc.fi; img-src * data:")
